<template>
    <header class="bg-gradient-to-r from-pink-100 to-purple-100 sticky top-0">
        ...
        <aside v-if="isMenuOpen" id="mobile-menu"
            class="md:hidden bg-white shadown-lg- py-4 px-4 absolute top-full left-0 right-0 z-40"
